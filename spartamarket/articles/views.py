...
def profile(request, username):
    ...
    return render(request, 'marketplace/profile.html', {'user': user, 'items': items, 'liked_items': liked_items, 'followers_count': followers_count, 'following_count': following_count})
...
def follow_user(request, username):
    ...
    if user_to_follow != request.user and user_to_follow not in user_profile.followed_by.all():
